...
const DUMMY_ENTRIES = [
  { id: 1, name: "Daily Calibration Log", cycle: "Daily" },
  { id: 2, name: "Weekly Equipment Cleaning", cycle: "Weekly" },
  {
    id: 3,
    name: "Alternative Day Sample Verification",
    cycle: "Alternative Days",
  },
  { id: 4, name: "Morning Shift Checklist", cycle: "Daily" },
  { id: 5, name: "Quarterly Safety Audit", cycle: "Weekly" }, // Changed to Weekly for demo filter
];
            ...
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-6 py-3.5 bg-indigo-600 text-white rounded-2xl font-bold shadow-lg shadow-indigo-200 hover:bg-indigo-700 hover:-translate-y-0.5 transition-all active:scale-95"
                >
              ...
              <div className="grid gap-4">
                {filteredEntries.map((entry) => (
                  ...
                  >
                    ...
                    <button className="mt-4 sm:mt-0 px-4 py-2 text-slate-400 hover:text-indigo-600 font-bold text-sm flex items-center gap-1 transition-colors">
                      View Details
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    {["Daily", "Weekly", "Alternative Days"].map((cycle) => (
                      <button
                        key={cycle}
                        type="button"
                ...
                <div className="flex gap-4 pt-4">
                  <button
                    ...
                    className="flex-1 px-6 py-4 border-2 border-slate-100 text-slate-500 font-bold rounded-2xl hover:bg-slate-50 transition-all flex items-center justify-center gap-2"
                  >
                    <X size={18} />
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="flex-1 px-6 py-4 bg-indigo-600 text-white font-black rounded-2xl shadow-lg shadow-indigo-200 hover:bg-indigo-700 hover:-translate-y-1 transition-all flex items-center justify-center gap-2"
                  >
