          ...
          <div className="grid grid-cols-3 gap-2">
            {CYCLES.map((c) => (
              <button
                key={c}
                onClick={() => setCycle(c)}
                className={`py-2.5 rounded-xl text-xs font-bold uppercase tracking-widest border-2 transition-all active:scale-95 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-1 ${
                  cycle === c
    ...
    <div>
      ...
      <div className="p-6 space-y-4">
        ...
        <div>
          ...
          <textarea
            className={css.input + " min-h-20 py-3 resize-none"}
            rows={3}
