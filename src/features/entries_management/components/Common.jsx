...
export const CYCLE_COLOR = {
    ...
    monthly: { bg: "#FFF7ED", text: "#C2410C", border: "#FED7AA", dot: "#F97316" },
};
...
export const css = {
    ...
    input:
        "w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm font-medium outline-none focus:border-indigo-500 focus:bg-white transition-all placeholder:text-slate-400",
    label:
        "block text-[11px] font-bold text-slate-500 uppercase tracking-widest mb-1.5",
    btnPri:
        "flex items-center gap-2 px-5 py-2.5 bg-indigo-600 text-gray-600 text-sm font-bold rounded-xl shadow-md hover:bg-indigo-700 active:scale-95 transition-all",
    btnSec:
        "flex items-center gap-2 px-5 py-2.5 bg-white text-slate-700 text-sm font-semibold rounded-xl border border-slate-200 hover:bg-slate-50 active:scale-95 transition-all",
    badge: (cycle) =>
