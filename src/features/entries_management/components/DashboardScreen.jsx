        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-2xl bg-indigo-600 flex items-center justify-center text-gray-600 shadow-lg shadow-indigo-200 shrink-0">
                ...
                <button onClick={onCreateNew} className={css.btnPri + " w-full sm:w-auto"}>
                            ...
                            >
                                ...
                                <div className="flex items-center justify-end sm:justify-start gap-2 shrink-0 border-t sm:border-t-0 pt-3 sm:pt-0 border-slate-50">
                                    ...
                                    <button
                                        ...
                                        className={css.btnSec + " text-xs py-2 px-6 flex-1 sm:flex-none justify-center"}
                                    >
                                        View →
                                    </button>
                                </div>
