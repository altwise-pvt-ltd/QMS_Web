...
import { Calendar as CalendarIcon, Filter, CheckSquare, Square, ChevronRight } from "lucide-react";
...
const QIFormSidebar = ({
    ...
    return (
        <div className="relative">
            ...
            <div className={`space-y-6 transition-all duration-300 ${isCollapsed ? "opacity-0 invisible scale-95" : "opacity-100 visible scale-100"}`}>
