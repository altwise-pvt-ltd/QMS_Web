...
const DocumentFormActions = ({ onSubmit, onCancel }) => {
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 sticky bottom-0">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          ...
          <button
            type="submit"
            className="px-5 py-2.5 text-sm font-medium text-gray-600 bg-blue-600 rounded-lg hover:bg-blue-700 shadow-md transition-colors flex items-center gap-2"
          >
            <Save size={18} />
            Save Documents
          </button>
