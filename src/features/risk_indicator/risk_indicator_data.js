export const RISK_INDICATORS = [
    // Impartiality Ethics
    { id: "risk-1", name: "Conflict of interest influencing results", category: "Impartiality Ethics", count: 2000, hasCapa: true, severity: 4, threshold: 100, incidents: [] },
    { id: "risk-2", name: "Commercial pressure affecting reporting", category: "Impartiality Ethics", count: 1, hasCapa: false, severity: 5, threshold: 0, incidents: [] },
    ...
    { id: "risk-8", name: "Noncompliance with statutory licenses", category: "Organizational Structure", count: 1, hasCapa: false, severity: 5, threshold: 0, incidents: [] },
    ...
    { id: "risk-14", name: "Biohazard exposure", category: "Facilities", count: 1, hasCapa: false, severity: 5, threshold: 0, incidents: [] },
    ...
    { id: "risk-22", name: "Pandemic staff loss", category: "Business Continuity", count: 1, hasCapa: false, severity: 5, threshold: 0, incidents: [] },
];
