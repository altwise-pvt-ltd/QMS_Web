...
const Tooltip = ({ children, content, className = "" }) => {
  ...
  return (
    ...
    >
      {children}
      {show && (
        <div className="absolute z-50 bottom-full left-1/2 -translate-x-1/2 mb-2 px-2.5 py-1.5 bg-slate-800 text-white text-[11px] rounded-lg shadow-lg whitespace-nowrap pointer-events-none">
          {content}
