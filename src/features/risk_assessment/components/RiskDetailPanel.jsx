        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-indigo-600 shadow-sm shadow-indigo-200 shrink-0">
              <span className="text-gray-600 text-[11px] font-black tracking-tight">
                {risk.id}
              </span>
            </div>
        ...
        {risk.score >= 6 && (
          <section className={`rounded-xl border p-4 ${cfg.bg} ${cfg.border}`}>
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              <a
                href={risk.capaLink || "#"}
                className="flex items-center gap-1.5 px-3.5 py-2 bg-indigo-600 text-gray-600 rounded-lg text-xs font-bold hover:bg-indigo-700  hover:text-gray-600   active:scale-95 transition-all shadow-sm whitespace-nowrap"
              >
                View Report
